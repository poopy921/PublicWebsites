...
var getThen = /(?<!\\)(?:\\\\)*\-\>|(?<!\\)(?:\\\\)*THEN/gm;
var getIff = /(?<!\\)(?:\\\\)*\<\-\>|(?<!\\)(?:\\\\)*IFF/gm;
var getEquals = /(?<!\\)(?:\\\\)*\=\=|(?<!\\)(?:\\\\)*EQUALS/gm;
var getAll = /(?<!\\)(?:\\\\)*qA|(?<!\\)(?:\\\\)*ALL|(?<!\\)(?:\\\\)*FOR EVERY/gm;
...
var descs = {
    ...
    "-equals": "The EQUALS statement says that a logical statement is equivalent to another logical statement.",
    ...
    "-symbolshort": "&& for AND<br>|| for OR<br>~ for NOT<br>-> for THEN<br><-> for IFF<br>== for EQUALS<br>qA for ALL (think of it as quantifierAll)<br>qE for EXISTS (think of it as quantifierExists)"
};
